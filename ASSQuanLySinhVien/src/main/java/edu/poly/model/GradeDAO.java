...
import edu.poly.database.DatabaseUtils;
...
public class GradeDAO {
    ...
    public Grade getOneGradeByMaSV(String maSV){
        ...
        ResultSet rs = null;
        try {
            String sSQL = "SELECT dbo.Grade.MaSV, dbo.SinhVien.TenSV, dbo.Grade.AnhVan, "
                    + "dbo.Grade.TinHoc, dbo.Grade.GDTC FROM dbo.Grade INNER JOIN "
